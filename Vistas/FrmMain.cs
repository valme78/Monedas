...
namespace CoinTrader
{
    public partial class Form1 : Form
    {
        ...
        /// <summary>
        /// Lista [string] donde se guardan el nombre de las monedas que se estan consultando.
        /// </summary>
        private List<string> lstMonedas = new List<string>(); //lista para guardar el nombre de las monedas activas.
        /// <summary>
        /// Delegado[apuntador] de un metodo el cual manda la informacion de la moneda consultada en un hilo[Thread] y lo actualiza en el grid.
        /// </summary>
        /// <param name="sMoneda">Nombre de la moneda que se quiere mostar el resultado</param>
        /// <param name="lvObj">Objeto de la clase del grid que se requiere actualizar</param>
        /// <param name="index">Indice donde se encuentra el renglon de la moneda a actualizar</param>
        public delegate void delegadomonedas(string sMoneda, DataGridView lvObj, Int32 index);
        /// <summary>
        /// Delegado[Apuntador] para pasar obtener los resultados de un metodo de la misma clase en un hilo. 
        /// </summary>
        /// <param name="text">mensaje de error del metodo si lo regresa</param>
        /// <param name="moneypp">estructura[list] donde se obtiene los datos de la moneda consultada</param>
        delegate void SetTextCallback(string text, CMoneyPrice moneypp);

        List<CMoneyPrice> lMoneyDia = new List<CMoneyPrice>(); ///lista donde se captura los datos de la monedas cada N segundos

        /// <summary>
        /// Variable global para capturar la hora y usarla para guardar los datos de las monedas cada hora.
        /// </summary>
        long lContHora = 0;
        ...
        {
            txtpreciomax.Text = string.Format("{0,14:N2}", Convert.ToDouble(dgvMonedas.SelectedRows[0].Cells["dgcolpreciomax"].Value));
        }
